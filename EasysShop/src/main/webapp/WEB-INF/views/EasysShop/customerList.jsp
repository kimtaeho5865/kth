...
<script type = "text/javascript">
	...
	$(document).ready(function() {
		...
		$("#update_Btn").on("click", function() {
			html = "";
			html += "<form action = \"#\" id = \"regForm\" method = \"post\">";
			...
			html += "<td class = \"field_contents\"><input type = \"text\" class = \"input_normal\"></td>";
			html += "<td class = \"field_name first_field_name\">담당자</td>";
			html += "<td class = \"field_contents\"><input type = \"text\" class = \"input_normal size40\"><input type=\"button\" class=\"btn_normal btn_size_normal\" value=\"검색\"/></td>";
			
			html += "</tr>";
			html += "<tr>";
			html += "<td class = \"field_name first_field_name\">성별</td>";
			html += "<td class = \"field_contents\"><select class = \"input_normal\"><option selected=\"selected\">여성</option><option>남성</option></select></td>";
			html += "<td class = \"field_name first_field_name\">생일</td>";
			html += "<td class = \"field_contents\"><input class=\"input_normal\" name=\"\" id=\"startDate1\" type=\"date\" value=\"\"></td>";
			html += "</tr>";
			html += "<tr>";
			html += "<td class = \"field_name first_field_name\">전화</td>";
			html += "<td class = \"field_contents\"><input type = \"text\" class = \"input_normal\"></td>";
			html += "<td class = \"field_name first_field_name\">휴대폰</td>";
			html += "<td class = \"field_contents\"><input type = \"text\" class = \"input_normal\"></td>";
			html += "</tr>";
			html += "<tr>";
			html += "<td class = \"field_name first_field_name\">등록일</td>";
			html += "<td class = \"field_contents\"><input class=\"input_normal\" name=\"\" id=\"startDate1\" type=\"date\" value=\"\"></td>";
			html += "<td class = \"field_name first_field_name\">방문일</td>";
			html += "<td class = \"field_contents\"><input class=\"input_normal\" name=\"\" id=\"startDate1\" type=\"date\" value=\"\"></td>";
			html += "</tr>";
			html += "<tr>";
			html += "<td class = \"field_name first_field_name\">기념일</td>";
			html += "<td class = \"field_contents\"><input class=\"input_normal\" name=\"\" id=\"startDate1\" type=\"date\" value=\"\"></td>";
			html += "<td class = \"field_name first_field_name\">등급</td>";
			html += "<td class = \"field_contents\">";
			html += "<select class = \"input_normal\">";
			html += "<option selected=\"selected\">BRONZE</option>";
			html += "<option>SILVER</option>";
			html += "<option>GOLD</option>";
			html += "<option>PLATINUM</option>";
			html += "<option>DIAMOND</option>";
			html += "<option>MASTER</option>";
			html += "<option>CHALLENGER</option>";
			html += "</select>"
			html += "</td>";
			html += "</tr>";
			html += "<tr class=\"height50\">";
			html += "<td class=\"field_name first_field_name\">주소<span class=\"important_text\">*</span></td>";
			html +=	"<td colspan=\"3\" class=\"text_align_left \">";
			html += "<input type=\"text\" class=\"input_size ml10 mt10\" placeholder=\"우편번호\"><div class=\"btn_normal btn_size_normal mt10\">검색</div>";
			html +=	"<input type=\"text\" class=\"input_size pxsize495 ml10 mt10 dis_block\" placeholder=\"주소\">";
			html += "<input type=\"text\" class=\"input_size pxsize495 ml10 mt10 mb10 dis_block\" placeholder=\"상세주소\">";
			html += "</tr>";
			html += "<tr>";
			html += "<td class=\"field_name first_field_name\">이메일</td>";
			html += "<td colspan = \"3\"><input type = \"text\" class = \"input_normal\" /></td>";
			html += "<tr>";
			html += "<th class=\"field_name first_field_name\">메모</th>";
			html += "<td colspan = \"3\"> <textarea type=\"text\" class=\"textarea_normal\"></textarea></td>";
			html += "</tr>";
			html += "</tr>";
			html += "</table>";
			html += "</form>";
			makeTwoBtnPopup(1, "고객등록", html, true, 600, 630, null, "수정", null, "취소", function(){
				closePopup(1);
			})
		});
		$("#reg_Btn").on("click", function() {
			...
			html += "</table>";
			html += "</form>";
			makeTwoBtnPopup(1, "고객등록", html, true, 600, 630, null, "등록", null, "취소", function(){
				closePopup(1);
			})
		});
